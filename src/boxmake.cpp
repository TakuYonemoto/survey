...
void boxmake()
{
   TFile *fout = new TFile("/Users/taku/Downloads/survey_data/boxmake1.root","recreate");
...
//// tr0 making /////
   ...
   for(Int_t i=0; i<Ng; i++){
      gr0->GetPoint(i,x,y,z);
      x *= -1.;
      y *= -1.;
      tr0->Fill();
      if(i%3){continue;}
      pm3->SetPoint(pN++,x,y,z);
   }
   tr0->Write();
   pm3->Write();
   Ng = tr0->GetEntries();
...
///// gr0 >> gj  //////
   ...
   cr0->cd();
   gr0->Draw("P");
   cr0->SaveAs("outputfiles/hako.pdf");
   c2->cd();
   g2->SetMarkerStyle(20);
   g2->SetMarkerSize(0.4);
   g2->SetMarkerColor(kBlack);
   g2->Draw("P");
   c2->SaveAs("outputfiles/fitted.pdf");
